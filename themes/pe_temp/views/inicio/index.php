        ...
        <div class="row items">
            <div class="col-lg-4 col-sm-4 col-xs-12 col-print-4">
                <div class="thumbnail">
                    ...
                    <p>INSTRUMENTAÇÃO DE EDIFÍCIOS, TERMOGRAFIA E ANÁLISES DE PRÉDIOS</p>
                </div>
            </div>
            <div class="col-lg-4 col-sm-4 col-xs-12 col-print-4">
                <div class="thumbnail">
            ...
            <div class="col-lg-4 col-sm-4 col-xs-12 col-print-4">
                <div class="thumbnail">
                    ...
                    <p>SEGURANÇA CONTRA INCÊNDIOS E MEDIDAS DE AUTOPROTEÇÃO</p>
                </div>
            </div>
        </div>
