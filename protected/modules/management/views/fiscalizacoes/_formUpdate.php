        ...
        <div class="form">
            ...
            <div class="row">
                <div class="col-lg-12 images_container">
                    ...
                    foreach ($model->supimgs as $image){
                        ...
                        echo '<span class="multifile_remove_input glyphicon glyphicon-remove oldRemove" id="'.$image["id_image"].'"></span>
                                ...
                                <img class="multifile_preview" src="'.Yii::app()->request->baseUrl.'/images/supervision/'.$model->id_sup.'/big/'.$image["imgName"].'"/>
...
<script type="text/javascript">
    $(document).ready(function(){
        ...
        $('.oldRemove').click(function(){
            ...
            var dataMod = <?php echo $model->id_sup;?>;
